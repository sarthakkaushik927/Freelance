  ...
  return (
    <div className="bg-background text-on-background min-h-screen font-body">
      ...
      <main>
        ...
        {/* New Gallery Section */}
        <section className="py-24 px-6 md:px-16 max-w-7xl mx-auto" id="gallery">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[250px] md:auto-rows-[300px]">
            {/* Image 1 - Large Left */}
            <div className="md:col-span-8 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5">
              <img 
              ...
              <div className="absolute bottom-0 left-0 p-8 transform translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all duration-500">
                <h3 className="font-display text-2xl text-on-surface">Intimate Settings</h3>
              </div>
            </div>

            {/* Image 2 - Small Right Top */}
            <div className="md:col-span-4 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5">
              <img 
                referrerPolicy="no-referrer"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-90 group-hover:opacity-100" 
                alt="Culinary detail" 
            ...
            {/* Image 4 - Medium Center */}
            <div className="md:col-span-4 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5">
              <img 
                referrerPolicy="no-referrer"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-90 group-hover:opacity-100" 
                alt="Exquisite preparation" 
            ...
            {/* Image 5 - Medium Right */}
            <div className="md:col-span-4 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5">
              <img 
                referrerPolicy="no-referrer"
                className="absolute inset-0 w-full h-full object-cover transition-transform duration-1000 group-hover:scale-105 opacity-90 group-hover:opacity-100" 
                alt="Masterful creation" 
        ...
        {/* The Culinary Art (Bento Grid) */}
        <section className="py-24 px-6 md:px-16 max-w-7xl mx-auto relative" id="menu">
          ...
          <div className="grid grid-cols-1 md:grid-cols-12 gap-6 auto-rows-[300px] md:auto-rows-[400px]">
            {/* Main Dish */}
            <div className="md:col-span-8 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5">
              <img className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 group-hover:opacity-100" alt="Top down, highly styled food photography of a modern, minimalist plated dish." src="https://lh3.googleusercontent.com/aida-public/AB6AXuCG8v7iQRWqwVdZwBiQuLqUKUUk3beOcaBmdolXa9Ix7mvaS-kVtQdIYtcAuIRU8cEB0Ec5mL8IQHZXwZhRm_LVr1G4RVLLStsexDzEEKQaxUBCpE8t762MMGg6N3IO0ZBejz0Cgu_qUtM_zolOXyDgwVwHOQEzdArwvrDi903sSSUGUHSKoilammo9yOTpYIcxyXKWw6FNxh3TGPegoxeMEiK3VhT9jqil5-3N1mjhZeGqDfj7ASJsQEOo2bQuDiQi8bT-TZImrDsv"/>
            ...
            {/* Side Dish 1 */}
            <div className="md:col-span-4 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5">
              <img className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 group-hover:opacity-100" alt="Close up food photography of a delicate dessert." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDedbz_Zo5T8CbVZ29XksVz-vZ7w5eoHBfByq6pg_VmH4QQmde_FLOxPfqaFCLFfwuwqzXjlzysFu9OwDw0mfPZwynv5xIfybB3zvex_dMtRNaWGEMI4r08KhneMNm85qByq7fhr3x2C8c7Z-J49nqKxAXQXFc05qR9clqHvpY1HJBSgixfdzwDMX4SdaP8yY9JRoivHFAzocq1lne--O_uJ9aBay_0Sa8Gu31G-Jx6ob7DWfnbYZZ2EgkUmJP2bew0SKsZg3q8F64n"/>
            ...
            {/* Side Dish 2 */}
            <div className="md:col-span-4 relative group overflow-hidden rounded-xl bg-surface-container-high border border-white/5">
              <img className="absolute inset-0 w-full h-full object-cover transition-transform duration-700 group-hover:scale-105 opacity-80 group-hover:opacity-100" alt="An artisan cocktail in a minimalist crystal coupe glass." src="https://lh3.googleusercontent.com/aida-public/AB6AXuDnfbM2nsQQOmXaQSafleX4KTyb3_wNumwCFDpTRhOjCng14kMtP1u-WovukLFuMyh0VV8VSOZqfumbGmDWpJBUaSvIeb5D79WqaR-OA4keB0NdHc6E-jZe4RtM-AIugu2RFBd_-9HOP6iahYbfWGUFQIEEknInQ6AaA-alJkir2c1D-zd49nVOp-EvjgUuT_Zy6i87qgT3IQuNboX6q-EujW_nfnFH1emUEUZZZTXSjlpF0Hs0XfOx5-_nbe-iNVM5GeGJMMnzre7o"/>
              <div className="absolute inset-0 bg-gradient-to-t from-background/90 to-transparent"></div>
              <div className="absolute bottom-0 left-0 p-6 w-full">
            ...
            {/* Abstract/Atmosphere block */}
            <div className="md:col-span-8 bg-surface-container flex items-center justify-center p-12 rounded-xl border border-white/5 relative overflow-hidden">
        ...
        <section className="py-24 relative bg-surface-container-lowest border-y border-white/5" id="story">
        ...
        <section className="py-32 px-6 md:px-16 max-w-7xl mx-auto" id="reservations">
